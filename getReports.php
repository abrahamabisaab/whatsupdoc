...
<html lang="en" dir="ltr">
  ...
  .title{
    ...
    <body>
      <h1 align=center class="title">List of Patient Reports</h1>
      ...
      $query="SELECT DISTINCT r.*,u.name FROM user u, report r, patient p, reserve res WHERE r.patientID=p.patientID AND p.userID=u.userID AND res.patientID = r.patientID AND res.doctorID=$doctorID ";
